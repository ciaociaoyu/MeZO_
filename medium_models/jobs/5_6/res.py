...
if __name__ == "__main__":
    # 请确保文件路径正确
    filepath = "stepH-sst-2full-bs16_36977358_1.out"
    filepath2 = "fixH-sst-2full-bs16_36977528_1.out"
    ...
    plot_results(df_train, df_eval, window_size=100, alpha=0.01, compare_plot=0, compare_filepath=filepath2)