...
EXP_ROOT="$ROOT/experiments/smoke/mezo/roberta-large/sst2/int8/perturb_delta_quant_local_h100_20260420_225949"
LOG_DIR="$EXP_ROOT/logs"
RESULT_ROOT="$EXP_ROOT/results"
JOB_NAME="run_local_h100_mezo_int8_sst2_perturb_delta_quant"
...
export EXTRA_TAG="smoke-local-h100-mezo-int8-sst2-perturb-delta-quant-h1e-4-10k"
