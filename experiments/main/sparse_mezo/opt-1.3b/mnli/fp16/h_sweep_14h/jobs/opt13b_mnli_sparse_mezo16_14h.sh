#!/bin/bash
#SBATCH --job-name=hsweep14h_sparsemezo16_opt13b_mnli
...
#SBATCH --chdir=/scratch/jy03364/MeZO_/experiments/main/sparse_mezo/opt-1.3b/mnli/fp16/h_sweep_14h
#SBATCH --output=/scratch/jy03364/MeZO_/experiments/main/sparse_mezo/opt-1.3b/mnli/fp16/h_sweep_14h/logs/slurm_%x_%j.out
...
EXPERIMENT_ROOT="/scratch/jy03364/MeZO_/experiments/main/sparse_mezo/opt-1.3b/mnli/fp16/h_sweep_14h"
