#!/bin/bash
#SBATCH --job-name=hsweep14h_sparsemezo16_roberta_sst5
...
#SBATCH --chdir=/scratch/jy03364/MeZO_/experiments/main/sparse_mezo/roberta-large/sst5/fp16/h_sweep_14h
#SBATCH --output=/scratch/jy03364/MeZO_/experiments/main/sparse_mezo/roberta-large/sst5/fp16/h_sweep_14h/logs/slurm_%x_%j.out
...
EXPERIMENT_ROOT="/scratch/jy03364/MeZO_/experiments/main/sparse_mezo/roberta-large/sst5/fp16/h_sweep_14h"
...
MANIFEST_FILE="${RESULT_ROOT_BASE}/manifest.jsonl"
...
for H in "${H_VALUES[@]}"; do
  ...
  export EPS="${H}"
  export EXTRA_TAG="hsweep14h-${VARIANT}-${TASK_KEY}-h${H}"
