#!/bin/bash
#SBATCH --job-name=hsweep14h_quzo16_opt13b_sst5
...
#SBATCH --chdir=/scratch/jy03364/MeZO_/experiments/main/mezo/opt-1.3b/sst5/fp16/h_sweep_14h
#SBATCH --output=/scratch/jy03364/MeZO_/experiments/main/mezo/opt-1.3b/sst5/fp16/h_sweep_14h/logs/slurm_%x_%j.out
...
EXPERIMENT_ROOT="/scratch/jy03364/MeZO_/experiments/main/mezo/opt-1.3b/sst5/fp16/h_sweep_14h"
