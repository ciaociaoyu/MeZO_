#!/bin/bash
#SBATCH --job-name=hsweep14h_quzo16_roberta_sst5
...
#SBATCH --chdir=/scratch/jy03364/MeZO_/experiments/main/mezo/roberta-large/sst5/fp16/h_sweep_14h
#SBATCH --output=/scratch/jy03364/MeZO_/experiments/main/mezo/roberta-large/sst5/fp16/h_sweep_14h/logs/slurm_%x_%j.out
