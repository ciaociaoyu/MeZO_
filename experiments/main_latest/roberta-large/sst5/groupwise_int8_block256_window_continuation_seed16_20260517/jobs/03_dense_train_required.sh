...
run_dense() {
  local h="$1"
  local h_tag="$2"
  local run_name="dense_groupwise256_fp16master_h${h_tag}_step5000"
  TASK=SST-5 K=16 SEED=16 DATA_SEED=16 DATASET_MODE=full FULL_DEV_RATIO=0.1 \
  BS=64 LR=1e-5 WD=0 EPS="${h}" STEP=5000 EVAL_STEP=500 MODEL=roberta-large \
...
run_dense "0.001" "1e-3"
run_dense "0.0015" "1p5e-3"
run_dense "0.002" "2e-3"
