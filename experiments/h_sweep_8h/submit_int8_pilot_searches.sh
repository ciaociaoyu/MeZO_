...
for item in \
  "roberta_mnli_mezo_int8 jobs/roberta_mnli_mezo_int8_8h.sh" \
  "roberta_sst5_mezo_int8 jobs/roberta_sst5_mezo_int8_8h.sh" \
  "opt13b_mnli_mezo_int8 jobs/opt13b_mnli_mezo_int8_8h.sh" \
  "opt13b_sst5_mezo_int8 jobs/opt13b_sst5_mezo_int8_8h.sh" \
  "roberta_mnli_sparse_mezo_int8 jobs/roberta_mnli_sparse_mezo_int8_8h.sh" \
  "roberta_sst5_sparse_mezo_int8 jobs/roberta_sst5_sparse_mezo_int8_8h.sh" \
  "opt13b_mnli_sparse_mezo_int8 jobs/opt13b_mnli_sparse_mezo_int8_8h.sh" \
  "opt13b_sst5_sparse_mezo_int8 jobs/opt13b_sst5_sparse_mezo_int8_8h.sh"
do
  label="${item%% *}"
  script="${item#* }"
