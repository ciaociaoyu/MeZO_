...
#SBATCH --requeue
#SBATCH --output=/scratch/jy03364/MeZO_/experiments/pilot/_shared/h_sweep_8h/logs/roberta_mnli_sparse_mezo_int8_l40s_%j.out

set -euo pipefail

ORIG_SCRIPT="/scratch/jy03364/MeZO_/experiments/pilot/sparse_mezo/roberta-large/mnli/int8/h_sweep_8h/jobs/roberta_mnli_sparse_mezo_int8_8h.sh"
