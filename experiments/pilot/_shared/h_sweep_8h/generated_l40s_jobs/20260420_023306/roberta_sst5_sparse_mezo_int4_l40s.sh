...
#SBATCH --chdir=/scratch/jy03364/MeZO_/experiments/pilot/sparse_mezo/roberta-large/sst5/int4/h_sweep_8h
#SBATCH --output=/scratch/jy03364/MeZO_/experiments/pilot/sparse_mezo/roberta-large/sst5/int4/h_sweep_8h/logs/slurm_%x_%j.out
...
export VARIANT="sparse_mezo_int4"
