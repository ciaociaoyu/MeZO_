...
for item in \
  ...
  "opt13b_mnli_mezo_int4 mezo/opt-1.3b/mnli/int4/h_sweep_8h/jobs/opt13b_mnli_mezo_int4_8h.sh" \
  "opt13b_sst5_mezo_int4 mezo/opt-1.3b/sst5/int4/h_sweep_8h/jobs/opt13b_sst5_mezo_int4_8h.sh" \
  ...
  "opt13b_mnli_sparse_mezo_int4 sparse_mezo/opt-1.3b/mnli/int4/h_sweep_8h/jobs/opt13b_mnli_sparse_mezo_int4_8h.sh" \
  "opt13b_sst5_sparse_mezo_int4 sparse_mezo/opt-1.3b/sst5/int4/h_sweep_8h/jobs/opt13b_sst5_sparse_mezo_int4_8h.sh"
do
  label="${item%% *}"
  script="${item#* }"
