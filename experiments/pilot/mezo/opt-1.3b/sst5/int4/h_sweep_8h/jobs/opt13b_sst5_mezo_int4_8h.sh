#!/bin/bash
#SBATCH --job-name=hsweep8h_mezo_int4_opt13b_sst5
...
#SBATCH --chdir=/scratch/jy03364/MeZO_/experiments/pilot/mezo/opt-1.3b/sst5/int4/h_sweep_8h
#SBATCH --output=/scratch/jy03364/MeZO_/experiments/pilot/mezo/opt-1.3b/sst5/int4/h_sweep_8h/logs/slurm_%x_%j.out
