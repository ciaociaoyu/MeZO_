...
#SBATCH --chdir=/scratch/jy03364/MeZO_/experiments/pilot/mezo/opt-1.3b/sst5/int8/h_sweep_8h
#SBATCH --output=/scratch/jy03364/MeZO_/experiments/pilot/mezo/opt-1.3b/sst5/int8/h_sweep_8h/logs/slurm_%x_%j.out
