#!/bin/bash
#SBATCH --job-name=hsweep8h_mezo_int8_roberta_sst5
...
#SBATCH --chdir=/scratch/jy03364/MeZO_/experiments/pilot/mezo/roberta-large/sst5/int8/h_sweep_8h
#SBATCH --output=/scratch/jy03364/MeZO_/experiments/pilot/mezo/roberta-large/sst5/int8/h_sweep_8h/logs/slurm_%x_%j.out
