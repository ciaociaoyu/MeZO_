...
EXPERIMENT_ROOT="${EXPERIMENT_ROOT:-${SCRATCH_ROOT}/experiments/pilot/mezo/roberta-large/sst5/int8/paper_k16_10k_bs64_lr1e-6_wd0_shuffle_nanguardonly_l4/runs/manual}"
...
export VARIANT="${VARIANT:-mezo_int8_paperk16_10k_bs64_lr1e-6_wd0_shuffle_nanguardonly}"
