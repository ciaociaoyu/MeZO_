...
EXP_ROOT="$ROOT/experiments/pilot/mezo/roberta-large/sst2/int8/single_dir_true_td_local_h100_20260420_222056"
LOG_DIR="$EXP_ROOT/logs"
RESULT_ROOT="$EXP_ROOT/results"
JOB_NAME="run_local_h100_mezo_int8_sst2_single_dir_true_td"
...
export EXTRA_TAG="pilot-local-h100-mezo-int8-sst2-single-dir-true-td-h1e-4-10k"
