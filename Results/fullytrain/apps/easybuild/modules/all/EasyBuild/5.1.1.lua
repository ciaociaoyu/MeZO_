...
local root = "/apps/easybuild/software/EasyBuild/5.1.1"
...
setenv("EBVERSIONEASYBUILD", "5.1.1")
setenv("EBDEVELEASYBUILD", pathJoin(root, "easybuild", "EasyBuild-5.1.1-easybuild-devel"))

prepend_path("PYTHONPATH", pathJoin(root, "lib", "python3.9", "site-packages"))
setenv("EB_INSTALLPYTHON", "/usr/bin/python3")
-- Built with EasyBuild version 5.1.0
