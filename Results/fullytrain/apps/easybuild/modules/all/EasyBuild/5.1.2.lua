...
local root = "/apps/easybuild/software/EasyBuild/5.1.2"
...
setenv("EBVERSIONEASYBUILD", "5.1.2")
setenv("EBDEVELEASYBUILD", pathJoin(root, "easybuild", "EasyBuild-5.1.2-easybuild-devel"))
